<template>
  <v-app>
    <v-app-bar>
      <div class="d-flex align-center pr-5" style="width: 100%; height: 100%">
        ...
        >
          ...
          <v-card
            style="border-color: #63adf2; border-style: solid; width: 250px"
            border
          >
            <div class="mx-auto text-center my-3">
              <div v-if="user.type === 'SIEM'">
                <v-btn
                  ...
                  flat
                  @click="
                    $router.push({ name: 'handleDevices' }).catch(() => {})
                  "
                  style="width: 90%"
                >
              ...
              <div
                v-if="
                  user.type === 'SIEM' &&
                  (!!user?.rolesUser?.accessLogsPermission ||
                    !!user?.rolesUser?.systemLogsPermission)
                "
              >
              ...
              <div v-if="user.type === 'SIEM' && user.isAdmin">
                ...
                <v-btn
                  ...
                  flat
                  @click="
                    $router.push({ name: 'distributorsHome' }).catch(() => {})
                  "
                  style="width: 90%"
                >
              ...
              <div v-if="user.isAdmin">
                ...
                <v-btn
                  ...
                  flat
                  @click="
                    $router.push({ name: 'superAdminHome' }).catch(() => {})
                  "
                  style="width: 100%"
                >
              ...
              <div
                v-if="
                  user.type === 'SIEM' &&
                  user?.rolesUser?.configurationPermission
                "
              >
                <v-divider class="my-3"></v-divider>
                <v-btn
                  ...
                  flat
                  @click="
                    $router.push({ name: 'configurations' }).catch(() => {})
                  "
                  style="width: 90%"
                >
...
export default {
  ...
  methods: {
    ...
    burgerIconClicked() {
      if (this.iconMenu === "mdi-menu") this.iconMenu = "mdi-menu-open";
      else this.iconMenu = "mdi-menu";
    },
