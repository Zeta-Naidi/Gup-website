        ...
        if (prevY < 0) {
          ...
          each(tooltips, (tooltip) => {
            ...
            if (bounds) {
              ...
              tooltip.set("bounds", { left: bounds.left, top, right: bounds.right, bottom });
...
var XYCursor = class extends Container {
  ...
  _updateXLine(tooltip) {
    let x = round(this._display.toLocal(tooltip.get("pointTo", { x: 0, y: 0 })).x, 2);
    if (this._toX != x) {
  ...
  _updateYLine(tooltip) {
    let y = round(this._display.toLocal(tooltip.get("pointTo", { x: 0, y: 0 })).y, 2);
    if (this._toY != y) {
...
//# sourceMappingURL=chunk-BBDATAAK.js.map
